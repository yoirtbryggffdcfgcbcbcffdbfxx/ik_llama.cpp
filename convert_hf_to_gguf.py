...
class LFM2Model(Model):
    ...
    def set_gguf_parameters(self):
        # A zero KV-head count marks a short-convolution layer in GGUF.
        # Older LFM2 configs expose full_attn_idxs; newer LFM2.5 configs expose
        # the normalized layer_types list.
        if "layer_types" in self.hparams:
            full_attention = [t == "full_attention" for t in self.hparams["layer_types"]]
        else:
